...
const Login = () => {
  ...
  return (
    <main className="bg-gradient-to-br from-[#1d0c37] via-[#2a1548] to-[#1d0c37] min-h-screen flex flex-col items-center justify-center p-4">
      <div className="w-full max-w-md">
        <Link
          href="/"
          className="inline-flex items-center gap-2 text-[#a98af7] hover:text-[#c4b5fd] transition-colors duration-300 mb-6 ml-11"
        >
      ...
      <div className="bg-white/10 backdrop-blur-sm border border-[#a98af7]/20 rounded-2xl p-8 shadow-2xl">
        ...
        <div className="relative mb-6">
          ...
          <div className="relative flex justify-center text-sm px-4 py-3">
            <span className="px-4 absolute -bottom-3 bg-transparent text-[#c4b5fd]">
              or login with email
            </span>
          </div>
        </div>
